...
- **Dev Server URL**: `http://127.0.0.1:5237`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/90b366a9-c62d-4dcd-81de-48d33cd9cc1e/preview`
- **Port**: `5237`
...
4. The dev server is accessible at `http://127.0.0.1:5237`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/90b366a9-c62d-4dcd-81de-48d33cd9cc1e/preview`
